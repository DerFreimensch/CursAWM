...
// CursAWM.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCursAWMApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCursAWMApp

CCursAWMApp::CCursAWMApp()
{
...
// Единственный объект CCursAWMApp

CCursAWMApp theApp;


// Инициализация CCursAWMApp

BOOL CCursAWMApp::InitInstance()
{
